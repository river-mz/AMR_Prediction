...
output_fig_dir = '/home/linp0a/AMR_prediction_pipeline/loss_auc_curves_Ours_US_Oct_5/'
if not os.path.exists(output_fig_dir):
    os.makedirs(output_fig_dir)  # 如果目录不存在，自动创建


output_dir = '/home/linp0a/AMR_prediction_pipeline/model_prediction/model_Ours_US_Oct_5'
...
final_df = final_df[final_df['source']=='US']
