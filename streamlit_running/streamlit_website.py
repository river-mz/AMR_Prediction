...
# 准备 GIF 文件路径
gif_path = "/home/linp0a/AMR_prediction_pipeline/model_prediction/load_model_and_test/resource/animated_icon.gif"
...
if selected == "Home":
    ...
    with stylable_container(
        ...
        if st.session_state.get('predict_clicked', False):
            ...
            results_csv_path = os.path.join(model_dir, 'combined_predictions_ver2.csv')
